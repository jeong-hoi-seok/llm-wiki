...
source:
  - 10_raw/expo/pages/modules/overview.mdx
  - 10_raw/expo/pages/modules/module-api.mdx
...
## 출처
- Expo Modules: `10_raw/expo/pages/modules/` (overview·module-api·autolinking·native-view-tutorial 등)
- Config Plugins: `10_raw/expo/pages/config-plugins/` (introduction·mods·plugins)
- CNG: `10_raw/expo/pages/workflow/continuous-native-generation.mdx`
